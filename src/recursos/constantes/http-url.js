...
export const url_allperfilesp = url_server + url_general + "allpefilesP"; //Arreglar a perfiles desde el backend
export const url_perfilesp = url_server + url_general + "perfilP/";
