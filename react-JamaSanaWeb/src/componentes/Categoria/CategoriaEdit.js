...
const CategoriaEdit = (props) => {
    ...
    const loadCategoria = async () => {
        ...
        const result = await axios.get(global.url_categoria + id);
        console.log(result);
    ...
    const onSubmit = async e => {
        ...
        await axios.put(global.url_categoria+id, formData, options).then(res => {
            console.log(res)
            history.push("/categorias");
        }).catch(error => {
            console.log(error)
                ...
                <Container>
                    <Container id="form-cont">
                        ...
                        <Row>
                          ...
                          <img id="addimg" src={global.url_static + categoria.imagen} />
                      </div>
                                    <FormGroup class="groupf mb-3">
                                        <div class="mt-3">
                                            <label>
