...
const CategoriaHome = (props) => {
  ...
  const deleteCategoria = async id => {
    ...
    await axios.delete(global.url_categoria + id, options).then(res => {
      console.log(res)
    }).catch(error => {
      console.log(error)
  ...
  function format(cell, row) {
    ...
    return (
      <div>
        ...
        <span><Link className="links-comida" onClick={() => deleteCategoria(cell)}><Icon.DashCircleFill id="delete" className="iconos"></Icon.DashCircleFill></Link></span>
      </div>
  ...
  const options = {
    ...
    sizePerPageList: [ {
      ...
      text: 'All', value: categorias.length
              ...
              props => (
                <div>
                  ...
                  <ClearSearchButton {...props.searchProps} />
                    ...
                    <div className="col-sm">
                    <Link id="addhome" className="btn btn-light" to="/categoria/add" >Añadir<Icon.Plus className="iconplus"></Icon.Plus></Link>
                  ...
                  <BootstrapTable bootstrap4  defaultSorted={defaultSorted} {...props.baseProps} bordered={false} pagination={paginationFactory(options)} />
                </div>
              )
            }
          </ToolkitProvider>
